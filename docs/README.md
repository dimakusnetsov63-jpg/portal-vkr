...
| [`AUDIT-2026-08-19-quality.md`](AUDIT-2026-08-19-quality.md) | Аудит раздела «Контроль качества»: реестр проблем, roadmap по фазам, Definition of Done |
...
- Разделы **Обзор**, **Маркетинг**, **Аналитика** и **Уведомления** показывают
  заглушку «раздел в разработке». До C-7 они показывали выдуманные цифры как
  рабочие; выдумка удалена целиком, а не заменена другой выдумкой. Разделы
  остались в меню и в матрице прав. **Описание вакансий** работает на
  статических данных из Excel — они настоящие, просто не редактируются
  в портале.
