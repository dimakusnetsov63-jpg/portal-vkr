...
4. Зафиксировать в [`DATABASE.md`](DATABASE.md), что настройки боевого проекта
   проверены и когда.
...
2. Обновить `ARCHITECTURE.md` и `DATABASE.md` под новую схему (профили, роли,
