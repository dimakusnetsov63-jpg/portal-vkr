...
/**
 * History entries for one demand cell (project + city + exact date), newest
 * first. Only ever called on demand (when the "История изменений" drawer
 * opens) — never loaded eagerly for the whole matrix.
 *
