    ...
    <div className={primitives.tableWrap}>
      ...
      */}
      <BlockBars
        ...
        hint="Длина полосы — как часто звучит возражение. Рядом число случаев и средний итог проверок, где оно встретилось: возражение, которое звучит часто и отрабатывается слабо, — это задача, а не наблюдение. По пяти случаям выводов не делают, поэтому число стоит рядом с процентом. Виды проверки здесь сложены в один ряд, а смысл у них разный: в самоотказе возражение — причина отказа, в прослушке КЦ — то, что прозвучало в разговоре. Чтобы читать их отдельно, выберите вид проверки в фильтре."
        order="keep"
        tone="neutral"
      />
